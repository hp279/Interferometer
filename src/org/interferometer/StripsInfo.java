...
public class StripsInfo
  {
	  ...
	  public static class StripsOptions
	  {
		  double h1, h2;
	  	  ...
	  	  public StripsOptions(double h1, double h2, double e0, double e1, double e2, 
	  			  				boolean eval_diff1, boolean eval_diff2)
	  	  {
	  		  this.h1 = h1;
			  this.h2 = h2;
			  this.e0 = e0;
	  	  ...
	  	  public boolean evalDiff(TableFunction2 function, double x, double y, double[] what)
	  	  {
	  		  ...
	  		  if(function.hasSquare(x, y, h1))
			  {
				  ...
				  return diff1[0] >= what[0]-e1 && diff1[0] <= what[0]+e1 && diff1[1] >= what[1]-e1 && diff1[1] <= what[1]+e1;
			  }
	  		  return false;
	  	  }
