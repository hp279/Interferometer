...
public class InterferometerRestoreFunction extends TableFunction2
{
  ...
  public InterferometerRestoreFunction(Type type, double minx, double maxx, double miny, double maxy, int m, int n, double a, double b, double lambda, double deltaz)
  {
  ...
  public void createStrips()
  {
	  ...
	  StripsInfo.StripsOptions options = new StripsInfo.StripsOptions(h1, h2, e0, e1, e2);
  ...
  {
	  return Utils.acos2(getValue(i, j), currentStripsInfo.getK(i, j)) * lambda / Math.PI;
  }
